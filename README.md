...
>
> **Phiên bản hiện tại: v6**
>
> **Bản cập nhật mới nhất: v7 — Source Trace, Thư viện Bộ đề, Mobile/PWA Polish**
...
| **Key Rotator thông minh** | Nhiều API key được xoay theo batch; key 403 bị loại ngay trong phiên, key quota/server-busy được cooldown có kiểm soát và concurrency tự thích nghi để tận dụng key free ổn định hơn. |
...
2. Hệ thống sẽ:
   ...
   - Tự hạ/tăng concurrency phù hợp khi key bị quota hoặc server bận
   - Tự lọc trùng lặp
