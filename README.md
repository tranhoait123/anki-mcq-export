...
4. [Video Hướng Dẫn & File Mẫu](#video-hướng-đẫn--file-mẫu)
...
10. [Công Nghệ Sử Dụng (Tech Stack)](#công-nghệ-sử-dụng-tech-stack)
...
5. Lặp lại Bước 2-4 để tạo thêm Key từ các Project khác nhau
...
Tải Anki tại <https://apps.ankiweb.net/> nếu chưa có.
...
> 💡 Trường `ExplanationHTML` chứa HTML được format sẵn with màu sắc đẹp mắt. Hãy đặt nó trong phần **Back** (mặt sau) của thẻ Anki.
...
2. **PDF lớn? Không sao!** — Hệ thống tự cắt PDF thành từng phần nhỏ (3 trang) with **kỹ thuật gối đầu** (overlap)
