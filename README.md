...
| **DOCX Native + Fallback thông minh** | Word có text thật được đọc trực tiếp từ `word/document.xml`, giữ highlight vàng làm đáp án đúng, tách MCQ trước khi gọi AI; Word scan sẽ được cảnh báo nên chuyển PDF/ảnh. |
...
|:---|:---|:---|
| **DOCX native: N câu** | App đọc trực tiếp XML của Word, tách được MCQ và giữ highlight vàng làm đáp án đúng. | Dùng luôn, đây là đường nhanh và chính xác nhất. |
...
| **DOCX Native Parser** | Đọc `word/document.xml`, giữ highlight vàng, tách MCQ 4/5 lựa chọn và chia batch 10 câu. |
...
Chỉ nên chuyển khi app báo **"Nên dùng PDF/Ảnh"** hoặc DOCX là ảnh scan dán vào Word. Nếu app báo **"DOCX native: N câu"**, hãy dùng native vì nhanh hơn, ít tốn token hơn và giữ được highlight đáp án.
